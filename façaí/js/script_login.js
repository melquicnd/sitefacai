class Validator {
  ...
  let submit = document.getElementById('btn-submity');
  ...
  btnNot.addEventListener('click', function () {
    ...
    let container = document.getElementById('main-on-container');
    let container2 = document.getElementById('main-container');
